...
# Check Redis
echo "Redis:"
REDIS_PASSWORD=$(~/minibot/bin/minibot-secrets.sh get REDIS_PASSWORD 2>/dev/null || echo "")
...
# Check MongoDB
echo "MongoDB:"
MONGO_PASSWORD=$(~/minibot/bin/minibot-secrets.sh get MONGO_PASSWORD 2>/dev/null || echo "")
