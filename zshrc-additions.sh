...
alias mb-llm-start='~/minibot/bin/minibot-llm-start.sh'
alias mb-llm-stop='~/minibot/bin/minibot-llm-stop.sh'
alias mb-llm-status='curl -s http://127.0.0.1:11434/ 2>/dev/null && echo "" && ollama list 2>/dev/null || echo "Ollama is not running"'
